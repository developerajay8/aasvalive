    ...
    return (
        <div className="w-full mx-auto">
            ...
            <section
                ...
                style={{ backgroundImage: "url('/computervision.png')" }}
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center text-white px-4">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-handel font-extrabold leading-tight mb-4">
                        Transforming Vision into Action with Computer Vision
                    </h1>
                    <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-poppins mb-6 max-w-4xl mx-auto">
                        Leverage cutting-edge AI to analyze and interpret visual data for smarter decision-making.
                    </p>
                    <Link
                        href="/contact"
            ...
            <section className="py-20 bg-white">
                <div className="container max-w-[1204px] mx-auto text-center px-4">
                    ...
                    <p className="text-lg sm:text-xl font-poppins text-gray-600 mb-12">
                        Have questions about computer vision? We’ve answered some of the most common ones below.
                    </p>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-gray-800">
                                    What is the cost of implementing computer vision?
                                </h3>
                            </div>
                            <p className="text-gray-600">
                                The cost varies depending on the complexity of the solution, the required technology stack, and the scale of deployment. Contact us for a tailored quote.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">
                                Industries such as healthcare, retail, automotive, manufacturing, and security can benefit from computer vision applications like object detection, facial recognition, and real-time monitoring.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <p className="text-gray-600">
                                The development timeline depends on the scope of the project. On average, it takes 2 to 6 months to build and deploy a robust computer vision solution.
                            </p>
                        </div>
                    </div>
                </div>
