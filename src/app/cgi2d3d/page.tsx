...
export default function Page() {
    ...
    return (
        <div className="w-full mx-auto">
            ...
            <section
                ...
                style={{ backgroundImage: "url('/2d3d.png')" }}
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center text-white px-4">
                    ...
                    Bring Your Vision to Life with Expert CGI Modeling
                    </h1>
                    <p className="text-lg sm:text-xl md:text-2xl mb-6 max-w-5xl mx-auto">
                    Innovative 2D/3D designs for all industries. Transform your ideas into visually captivating models.
                    </p>
                    <Link
                        href="/contact"
  ...
  <div className="container max-w-[1204px] mx-auto text-center px-4">
    ...
    <p className="text-lg sm:text-xl font-poppins text-gray-600 mb-12">
      Have questions about CGI, 2D, or 3D animation? We’ve answered some of the most common ones below.
    </p>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        <div className="flex items-center mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-800">
            What is the cost of creating a CGI animation?
          </h3>
        </div>
        <p className="text-gray-600">
          The cost varies depending on the complexity of the animation, the duration, and the level of detail required. Contact us for a custom quote tailored to your projects needs.
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        <div className="flex items-center mb-4">
          <FaRegQuestionCircle className="text-blue-600 text-3xl mr-4" />
          <h3 className="text-xl font-semibold text-gray-800">
            What industries use CGI, 2D, or 3D animation?
          </h3>
        </div>
        <p className="text-gray-600">
          Industries like entertainment, gaming, advertising, architecture, education, and healthcare use CGI, 2D, and 3D animation for visual storytelling, product demos, and simulations.
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        ...
        <p className="text-gray-600">
          The timeline depends on the scope and complexity of the project. A basic 3D animation can take 2-4 weeks, while a highly detailed animation may require several months.
        </p>
      </div>
    </div>
  </div>
