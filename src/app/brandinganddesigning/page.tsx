...
export default function Page() {
    ...
    return (
        <div className="w-full mx-auto">
            ...
            <section
                ...
                style={{ backgroundImage: "url('/brandinganddesining.png')" }}
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-center text-white px-4">
                    ...
                    Empower Your Brand with Stunning Designs
                    </h1>
                    <p className="text-lg sm:text-xl md:text-2xl mb-6 max-w-5xl mx-auto">
                    Professional branding & designing solutions tailored to your business needs.
                    </p>
                    <Link
                        href="/contact"
  ...
  <div className="container max-w-[1204px] mx-auto text-center px-4">
    ...
    <p className="text-lg sm:text-xl font-poppins text-gray-600 mb-12">
      Have questions about branding and designing? We’ve answered some of the most common ones below.
    </p>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        ...
        <p className="text-gray-600">
          Branding creates a unique identity for your business, helps build trust with customers, and sets you apart from competitors. A strong brand can enhance recognition and loyalty.
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        <div className="flex items-center mb-4">
          <FaRegQuestionCircle className="text-blue-600 text-3xl mr-4" />
          <h3 className="text-xl font-semibold text-gray-800">
            What is the difference between branding and designing?
          </h3>
        </div>
        <p className="text-gray-600">
          Branding is about defining your businesss identity, including mission, values, and voice, while designing involves creating visual elements like logos, typography, and layouts that represent your brand.
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
        <div className="flex items-center mb-4">
          <FaRegQuestionCircle className="text-blue-600 text-3xl mr-4" />
          <h3 className="text-xl font-semibold text-gray-800">
            How long does it take to develop a complete brand identity?
          </h3>
        </div>
        <p className="text-gray-600">
          Developing a complete brand identity depends on the scope of the project. It typically takes 4-8 weeks, including logo design, color schemes, typography, and brand guidelines.
        </p>
      </div>
    </div>
  </div>
